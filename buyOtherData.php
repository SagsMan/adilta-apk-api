...
sendUserPushNotification($conn, $email,
    $status ? '\u2705 Data Purchase Successful' : '\u274c Data Purchase Failed',
    $status ? "Your data purchase of \u20a6{$amount} was successful." : 'Data purchase failed. Wallet has been refunded.',
    ['screen' => 'Transactions', 'type' => ($status ? 'data_success' : 'data_failed')]
);
