...
sendUserPushNotification($conn, $email, '\u274c Electricity Purchase Failed', 'Electricity payment failed. Your wallet has been refunded.', ['screen' => 'Transactions', 'type' => 'electricity_failed']);
...
sendUserPushNotification($conn, $email, '\u2705 Electricity Purchase Successful', "Your electricity token of \u20a6{$amount} is ready. Token: {$tokenCode}", ['screen' => 'Transactions', 'type' => 'electricity_success']);
