...
sendUserPushNotification($conn, $email,
    $status ? '\u2705 PIN Generated Successfully' : '\u274c PIN Generation Failed',
    $status ? 'Your education PIN has been generated.' : 'PIN generation failed. Wallet has been refunded.',
    ['screen' => 'Transactions', 'type' => ($status ? 'edu_success' : 'edu_failed')]
);
