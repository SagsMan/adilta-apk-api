...
sendUserPushNotification($conn, $email,
    $status ? '\u2705 Airtime Successful' : '\u274c Airtime Failed',
    $status ? "Your airtime of \u20a6{$amount} was purchased successfully." : 'Airtime failed. Wallet has been refunded.',
    ['screen' => 'Transactions', 'type' => ($status ? 'airtime_success' : 'airtime_failed')]
);
