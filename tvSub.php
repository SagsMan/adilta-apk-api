...
// Push notification
sendUserPushNotification($conn, $email,
    $status ? '\u2705 TV Subscription Successful' : '\u274c TV Subscription Failed',
    $status ? "Your TV subscription of \u20a6{$amount} was successful." : 'TV subscription failed. Wallet has been refunded.',
    ['screen' => 'Transactions', 'type' => ($status ? 'tv_success' : 'tv_failed')]
);
